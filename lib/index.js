...
export default function slackin ({
  ...
  app.get('/', (req, res) => {
    ...
    res.type('html')
    res.render('main', { coc, path, name, org, logo, channels, active, total, gcaptcha_sitekey })
  })
  ...
  app.get('/iframe', (req, res) => {
    ...
    res.type('html')
    res.render('iframe', { path, active, total, large, logo, js, css })
  })
  ...
  app.get('/iframe/dialog', (req, res) => {
    ...
    if (!name) return res.send(404)
    res.type('html')
    res.render('splash', { coc, path, name, org, channels, active, total, large, gcaptcha_sitekey, iframe: true })
  })
